  ...
  ({ ...props }, ref) => {
    ...
    return (
      <button
        ...
        {...props}
        className={cn(
          "carousel-prev group relative z-20 flex h-12 w-12 items-center justify-center",
  ...
  ({ ...props }, ref) => {
    ...
    return (
      <button
        ...
        {...props}
        className={cn(
          "carousel-next group relative z-20 flex h-12 w-12 items-center justify-center",
