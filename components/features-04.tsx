        ...
        <div className="pb-12 pt-16 md:pb-20 md:pt-32">
          ...
          <div className="max-w-3xl pb-12 md:pb-20">
            ...
            <p className="text-lg text-slate-400">
              ...
              a search will uncover many web sites still in their infancy.
            </p>
          </div>
          ...
          <div className="divide-y divide-slate-800">
            ...
            <div className="py-8 first-of-type:pt-0 last-of-type:pb-0">
              <div>
                <div className="inline-flex bg-gradient-to-r from-buttercup-500 to-buttercup-200 bg-clip-text pb-6 font-medium text-transparent">
                  API Authorization
                </div>
              </div>
