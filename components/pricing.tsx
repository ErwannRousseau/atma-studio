            ...
            <div className="grid text-sm md:grid-cols-4 xl:-mx-6 [&>div:nth-last-of-type(-n+4)]:pb-6 max-md:[&>div:nth-last-of-type(-n+4)]:mb-8 max-md:[&>div:nth-last-of-type(-n+4)]:rounded-b-3xl md:[&>div:nth-last-of-type(1)]:rounded-br-3xl before:[&>div:nth-last-of-type(2)]:border-b-2 md:[&>div:nth-last-of-type(3)]:rounded-bl-3xl max-md:[&>div:nth-of-type(-n+4):nth-of-type(n+1)]:rounded-t-3xl [&>div:nth-of-type(-n+4)]:py-6 md:[&>div:nth-of-type(2)]:rounded-tl-3xl before:[&>div:nth-of-type(3)]:border-t-2 md:[&>div:nth-of-type(4)]:rounded-tr-3xl [&>div:nth-of-type(4n+1)]:bg-transparent max-md:[&>div:nth-of-type(4n+2)]:order-1 [&>div:nth-of-type(4n+3)]:relative before:[&>div:nth-of-type(4n+3)]:pointer-events-none before:[&>div:nth-of-type(4n+3)]:absolute before:[&>div:nth-of-type(4n+3)]:-inset-px before:[&>div:nth-of-type(4n+3)]:-z-10 before:[&>div:nth-of-type(4n+3)]:rounded-[inherit] before:[&>div:nth-of-type(4n+3)]:border-x-2 before:[&>div:nth-of-type(4n+3)]:border-buttercup-500 max-md:[&>div:nth-of-type(4n+3)]:order-2 max-md:[&>div:nth-of-type(4n+4)]:order-3 max-md:[&>div:nth-of-type(4n+5)]:hidden max-md:md:[&>div:nth-of-type(n)]:mb-0 [&>div]:bg-slate-700/20">
              ...
              <div className="flex flex-col justify-end px-6">
                <div className="mb-4 grow border-b border-slate-800 pb-4">
                  <div className="bg-gradient-to-r from-buttercup-500 to-buttercup-200 bg-clip-text pb-0.5 text-base font-medium text-transparent">
                    Pro
                  </div>
                  <div className="mb-1">
              ...
              <div className="flex flex-col justify-end px-6">
                ...
                <div className="border-b border-slate-800 pb-4">
                  ...
                  >
                    Get Started{' '}
                    <span className="ml-1 tracking-normal text-buttercup-300 transition-transform duration-150 ease-in-out group-hover:translate-x-0.5">
                      -&gt;
                    </span>
                  </a>
                </div>
              ...
              <div className="flex flex-col justify-end px-6">
                <div className="mt-4 py-2 font-medium text-slate-50 md:hidden">Usage</div>
              </div>
              <div className="flex flex-col justify-end px-6">
                <div className="mt-4 py-2 font-medium text-slate-50 md:hidden">Usage</div>
              </div>
              ...
              {/* Social Connections */}
              <div className="flex flex-col justify-end px-6">
                <div className="border-b border-slate-800 py-2 text-slate-400">Social Connections</div>
              </div>
              <div className="flex flex-col justify-end px-6">
              ...
              {/* Custom Domains */}
              <div className="flex flex-col justify-end px-6">
                <div className="border-b border-slate-800 py-2 text-slate-400">Custom Domains</div>
              </div>
              <div className="flex flex-col justify-end px-6">
                <div className="flex h-full items-center border-b border-slate-800 py-2 text-slate-400">
                  <svg
              ...
              <div className="flex flex-col justify-end px-6">
                <div className="border-b border-slate-800 py-2 text-slate-400">User Role Management</div>
              </div>
              <div className="flex flex-col justify-end px-6">
                <div className="flex h-full items-center border-b border-slate-800 py-2 text-slate-400">
                  <svg
              ...
              {/* External Databases */}
              <div className="flex flex-col justify-end px-6">
                <div className="border-b border-slate-800 py-2 text-slate-400">External Databases</div>
              </div>
              <div className="flex flex-col justify-end px-6">
                <div className="flex h-full items-center border-b border-slate-800 py-2 text-slate-400">
                  <svg
              ...
              <div className="flex flex-col justify-end px-6">
                <div className="mt-4 py-2 font-medium text-slate-50 md:hidden">Features</div>
              </div>
              <div className="flex flex-col justify-end px-6">
                <div className="mt-4 py-2 font-medium text-slate-50 md:hidden">Features</div>
              </div>
              ...
              {/* Custom Connection */}
              <div className="flex flex-col justify-end px-6">
                <div className="border-b border-slate-800 py-2 text-slate-400">Custom Connection</div>
              </div>
              <div className="flex flex-col justify-end px-6">
                <div className="flex h-full items-center border-b border-slate-800 py-2 text-slate-400">
                  <svg
              ...
              <div className="flex flex-col justify-end px-6">
                <div className="border-b border-slate-800 py-2 text-slate-400">Advanced Deployment Options</div>
              </div>
              <div className="flex flex-col justify-end px-6">
                <div className="flex h-full items-center border-b border-slate-800 py-2 text-slate-400">
                  <svg
              ...
              {/* Extra Add-ons */}
              <div className="flex flex-col justify-end px-6">
                <div className="border-b border-slate-800 py-2 text-slate-400">Extra Add-ons</div>
              </div>
              <div className="flex flex-col justify-end px-6">
                <div className="flex h-full items-center border-b border-slate-800 py-2 text-slate-400">
                  <svg
              ...
              {/* Admin Roles */}
              <div className="flex flex-col justify-end px-6">
                <div className="border-b border-slate-800 py-2 text-slate-400">Admin Roles</div>
              </div>
              <div className="flex flex-col justify-end px-6">
              ...
              {/* Deploy and Monitor */}
              <div className="flex flex-col justify-end px-6">
                <div className="border-b border-slate-800 py-2 text-slate-400">Deploy and Monitor</div>
              </div>
              <div className="flex flex-col justify-end px-6">
                <div className="flex items-center border-b border-slate-800 py-2 text-slate-400 max-md:hidden">
                  <span>
              ...
              {/* Enterprise Add-ons */}
              <div className="flex flex-col justify-end px-6">
                <div className="border-b border-slate-800 py-2 text-slate-400">Enterprise Add-ons</div>
              </div>
              <div className="flex flex-col justify-end px-6">
                <div className="flex items-center border-b border-slate-800 py-2 text-slate-400 max-md:hidden">
                  <span>
              ...
              <div className="flex flex-col justify-end px-6">
                <div className="mt-4 hidden py-2 font-medium text-slate-50">Support</div>
              </div>
              <div className="flex flex-col justify-end px-6">
                <div className="mt-4 py-2 font-medium text-slate-50 md:hidden">Support</div>
              </div>
              <div className="flex flex-col justify-end px-6">
                <div className="mt-4 py-2 font-medium text-slate-50 md:hidden">Support</div>
              </div>
              {/* Premium Support */}
              <div className="flex flex-col justify-end px-6">
                <div className="border-b border-slate-800 py-2 text-slate-400">Premium Support</div>
              </div>
              <div className="flex flex-col justify-end px-6">
                <div className="flex items-center border-b border-slate-800 py-2 text-slate-400 max-md:hidden">
                  <span>
