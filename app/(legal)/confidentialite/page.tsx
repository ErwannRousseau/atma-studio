...
export default function PolitiqueConfidentialitePage() {
  return (
    <div className="p-6">
      ...
      <p className="mb-4">
        Chez ATMA STUDIO, nous attachons une grande importance à la protection
        de votre vie privée. Cette politique de confidentialité explique comment
      ...
      <p className="mb-4">
        Nous ne collectons aucune information personnelle identifiable, y
        compris les adresses e-mail, sauf si vous nous la fournissez
        volontairement, par exemple, en nous contactant par e-mail ou en
      ...
      <p className="mb-4">
        Les informations que vous nous fournissez peuvent être utilisées pour
        répondre à vos demandes, améliorer nos services et vous contacter si
        nécessaire.
      </p>
      <h2 className="mt-4 mb-2 font-semibold text-xl">
      ...
      <p className="mb-4">
        Nous prenons des mesures pour protéger vos informations personnelles et
        ne les partageons pas avec des tiers sans votre consentement explicite.
      </p>
